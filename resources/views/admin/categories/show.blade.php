<x-app-layout>
    ...
    <div class="btn btn-primary justify-end">
        <a href="{{route('categories.create')}}"
            class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Add Categories</a>
    </div>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td
                             ...
                             <a href="{{ route('categories.edit',$item->cat_id) }}"
                         ...
                         <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200">
                            <form action="{{ route('categories.delete', $item->cat_id) }}" method="POST">
                                @csrf
                                @method('DELETE')
