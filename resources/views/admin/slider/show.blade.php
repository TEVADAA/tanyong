<x-app-layout>
    ...
    <div class="btn btn-primary justify-end">
        <a href="{{route('slider.create')}}"
            class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Add Slider</a>
    </div>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr>
                            ...
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Description Upper</th>
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Description Middle</th>
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Description Lower</th>
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Created_At</th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">
                                    <img src="{{ asset('uploads/slider/'.$item->background) }}" width="100px" height="100px" alt="">
                                </div>
                            </td>
